          ...
          <div className="container lg:flex lg:items-center w-full">
            ...
            <div className="text-white flex flex-col items-center lg:w-[50%] lg:text-[20px]">
              ...
              <p className="text-justify">
                Hi ! I'm Anuj Dhungana , a passionate MERN stack developer with
                a keen interest in crafting robust and scalable web
                applications. With a solid foundation in JavaScript and
                extensive experience with the MERN (MongoDB, Express.js,
                React.js, Node.js) stack, I thrive on bringing innovative ideas
              ...
              {showMore && (
                <p className="text-justify">
                  ...
                  that not only look great but also offer exceptional
